...
public final class CalibrationLayout {
    ...
    public static List<Page> pages(String key) {
        ...
        if(profile!=null&&profile.buttonOnly()){
            pages.add(new Page("sight",24,3,SIGHT));pages.add(new Page("port",27,3,null));return List.copyOf(pages);
        }
        ...
        // M700 port is visual; M870 side port is an actual shell-loading zone.
