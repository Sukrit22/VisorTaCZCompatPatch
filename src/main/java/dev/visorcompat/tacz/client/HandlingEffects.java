...
public final class HandlingEffects {
    ...
    public static void receive(CompatNetwork.Feedback m){
        ...
        if(m.kind()!=4 || m.gun().getPath().equals("m870")){
    ...
    @SubscribeEvent public static void render(RenderLevelStageEvent e){
        ...
        for(var r:ROUNDS){
            ...
            var model=m.kind()==3?index.getAmmoEntityModel():index.getShellModel();
            var texture=m.kind()==3?index.getAmmoEntityTextureLocation():index.getShellTextureLocation();
